const projects = [
    {
        ...
        year: "2K18",
        role: "UI, UX",
        txt: "Vibu is the modern solution that helps people to stop their drug consumption. The app offers a real aftercare through a chatbot which acts as a coach. Vibu also proposes personalized challenges and an active community you can interact with.",
        imgs: [
    ...
    },
    {
        ...
        year: "2K17",
        role: "UI, UX, Motion",
        txt: "Paris has been selected to host the 2024 Olympic Games. In order to immerse the whole world in this event, we had to create a dedicated app. This app must include all the Olympics informations, the sale of tickets and the lighting of Paris. ",
        imgs: [
    ...
    },
    {
        ...
        txt: "Here is a series of things I do in my spare time. I try to experiment with different fields, media and techniques. ",
        imgs: [
